...
$proj = Join-Path $repo 'src\Lait.Umbraco.Content.DragAndDrop\Lait.Umbraco.Content.DragAndDrop.csproj'
...
Write-Host "  dotnet add package Lait.Umbraco.Content.DragAndDrop" -ForegroundColor Green
Write-Host ""
